...
def parse_args():
    ...
    ap.add_argument("--perf", default="fast", choices=("fast", "medium", "slow"))
    ...
    ap.add_argument("--downscale", type=float, default=0.5, help="Downscale factor (4K->2K ~ 0.5)")
    ap.add_argument("--min-width", type=int, default=0)
    ap.add_argument("--min-height", type=int, default=0)

    ap.add_argument("--tile", type=int, default=64)
    ap.add_argument("--pix-step", type=int, default=12)
    ap.add_argument("--tile-sample", type=float, default=0.9)
    ap.add_argument("--tile-keep", type=float, default=0.7)
